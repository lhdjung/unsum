...
```{r}
#| fig.alt: >
#|   Two barplots like the first, except they show
#|   the subsets of samples within `data` with
#|   minimum and maximum horns index values.
closure_plot_bar_min_max(data, format = "percent")
```
