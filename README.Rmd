...
Your R version should be 4.2.0 or more recent. To run unsum, you also need a Rust installation; see [*Installing Rust for unsum*](https://lhdjung.github.io/unsum/articles/install-rust.html).
