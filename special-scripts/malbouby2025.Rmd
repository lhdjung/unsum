...
```{r}
closure_plot_bar_min_max(data_bmi, frequency = "percent")
```
...
```{r}
closure_plot_bar(data_age, frequency = "percent")
```
...
```{r}
closure_plot_bar_min_max(data_age, frequency = "absolute", text_size = 10)
